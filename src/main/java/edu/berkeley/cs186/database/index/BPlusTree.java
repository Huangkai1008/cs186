...
public class BPlusTree {
    ...
    private class BPlusTreeIterator implements Iterator<RecordId> {
        ...
        LeafNode nextNode;
        Iterator<RecordId> nextIterator;

        public BPlusTreeIterator(LeafNode leafNode, Iterator<RecordId> leftNodeIter) {
            this.nextNode = leafNode;
            this.nextIterator = leftNodeIter;
        }

        @Override
        public boolean hasNext() {
            return nextIterator.hasNext() || nextNode.getRightSibling().isPresent();
        }
